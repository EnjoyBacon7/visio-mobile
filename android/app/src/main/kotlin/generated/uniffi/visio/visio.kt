...
fun uniffi_visio_ffi_fn_method_visioclient_create_room(`ptr`: Pointer,`meetUrl`: RustBuffer.ByValue,`name`: RustBuffer.ByValue,`accessLevel`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_visio_ffi_checksum_method_visioclient_create_room() != 121.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface VisioClientInterface {
    ...
    fun `createRoom`(`meetUrl`: kotlin.String, `name`: kotlin.String, `accessLevel`: kotlin.String): CreateRoomResult
...
open class VisioClient: Disposable, AutoCloseable, VisioClientInterface
{
    ...
    @Throws(VisioException::class)override fun `createRoom`(`meetUrl`: kotlin.String, `name`: kotlin.String, `accessLevel`: kotlin.String): CreateRoomResult {
            return FfiConverterTypeCreateRoomResult.lift(
    callWithPointer {
    uniffiRustCallWithError(VisioException) { _status ->
    UniffiLib.INSTANCE.uniffi_visio_ffi_fn_method_visioclient_create_room(
        it, FfiConverterString.lower(`meetUrl`),FfiConverterString.lower(`name`),FfiConverterString.lower(`accessLevel`),_status)
}
    }
    )
    }
